...
```json
"features": {
        "ghcr.io/codspace/features/powershell:1": {
            "version": "latest"
        }
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/codspace/features/blob/main/src/powershell/devcontainer-feature.json)._
